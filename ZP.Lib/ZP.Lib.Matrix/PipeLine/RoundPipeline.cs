...
namespace ZP.Lib.Matrix
{
        ...
        IRoundPipeline
    {
        ...
        private Subject<Unit> readySubject = new Subject<Unit>();
        ...
        public IObservable<Unit> OnReadyObservable => readySubject.ObserveOn(innerScheder);

        public IObservable<Unit> OnStartObservable => startSubject.ObserveOn(innerScheder);

        public IObservable<Unit> OnStopObservable => stopSubject.ObserveOn(innerScheder);
        ...
        public IObservable<ZNull> Start()
        {
            ...
            var obser = Send<ZNull, ZNull>("roundstart").Do(_ => startSubject.OnNext(Unit.Default)).ObserveOn(innerScheder);
        ...
        {
            var obser = Send<ZNull, ZNull>("roundstop").Do(_ => stopSubject.OnNext(Unit.Default)).ObserveOn(innerScheder);
        ...
        public IObservable<Unit> PostAction<TData>(TCmd cmd, TData data)
        {
        ...
        public IObservable<Unit> PostAction(CmdPackage<TCmd> data)
        {
            var url = GetBaseUrl() + "roundcmd";
        ...
        static public CmdPackage<TCmd> DecodeCmd<TCmd>(IRawDataPref rawData)
        {
