...
namespace ZP.Lib.Core.Values
{
    ...
    {
        //optional
        private ZProperty<IZMsg> msgRef = new ZProperty<IZMsg>();

        private ZProperty<string> modelName = new ZProperty<string>("Hint");

        private ZProperty<ZTransform3> transform = new ZProperty<ZTransform3>();
