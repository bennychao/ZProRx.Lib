...
namespace ZP.Lib.Common
{
    ...
    //where TE2: Enum
    {
        ...
        public MultiEnum(TE1 e1)
        {
            value = (uint)(int)(object)e1;
        }
        public MultiEnum(TE2 e2)
        {
            value = (uint)(int)(object)e2;
        }
        ...
        //public static implicit operator MultiEnum<TE1, TE2>(object objValue)
        //{
        //    return (MultiEnum<TE1, TE2>)(objValue.ToString());
        //}
