...
namespace ZP.Lib
{
    ...
    //IObservable<ZNull>  From IObservable<string>
    internal class NetRequestObservable : OperatorObservableBase<ZNull>
    {
        public IObservable<string> request;
        public NetRequestObservable(IObservable<string> request) : base(true)
        {
        ...
        protected override IDisposable SubscribeCore(IObserver<ZNull> observer, IDisposable cancel)
        {
            return new NetResponse(this, observer);
        }
        ...
        class NetResponse : IDisposable
        {
            ...
            public IDisposable disposable;
            IObserver<ZNull> observer;

            public NetResponse(NetRequestObservable parent, IObserver<ZNull> observer)
            {
                this.parent = parent;
                this.observer = observer;
