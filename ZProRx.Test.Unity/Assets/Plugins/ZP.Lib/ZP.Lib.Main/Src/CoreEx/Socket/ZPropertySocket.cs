...
namespace ZP.Lib
{
    public static class ZPropertySocket {
        ...
        //no recevie msg
        static public IObservable<Unit> Post(string url, Dictionary<string, string> query = null)
        {
        ...
        //param:raw obj 
        static public IObservable<Unit> Post(string url, object obj)
        {
            ...
            return sub;
#else
            return TTPClient.Instance.SendMsg(url, strQuery).Select(_=> Unit.Default);
            //return Observable.NextFrame();
#endif

        }

        static public IObservable<Unit> PostPackage<T>(string url, T obj)
        {
        ...
        /// <returns></returns>
        static public IObservable<Unit> Send(string url, object obj)
        {
            string strQuery = ZPropertyPrefs.ConvertToStr(obj);
            //NetRequestObservable<Unit> sub = null;
